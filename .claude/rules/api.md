...
**Auto-loads when:** Working with FastAPI endpoints
...
class ChatRequest(BaseModel):
    ...
    @validator("model")
    def model_supported(cls, v: str) -> str:
        """Validate model is supported."""
        supported = ["gpt-4o", "claude-sonnet-4", "gemini-2.0-flash"]
...
✅ **Pattern for Server-Sent Events:**
...
class SSEWriter:
    ...
    async def write_event(self, event_type: str, data: Any) -> str:
...
class LatencyMiddleware(BaseHTTPMiddleware):
    """Log request latency for all endpoints."""
